            ...
            <div className="Section1__title">
                <div className="container">
                    ...
                    <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                        Mỗi một dàn cồng chiêng là tiếng nói tâm linh, tâm hồn của người Tây Nguyên, để diễn tả những niềm vui, nỗi buồn trong cuộc sống lao động và sinh hoạt hàng ngày của họ. Các tộc người ở Tây Nguyên sử dụng cồng chiêng theo cách thức riêng để chơi những bản nhạc của riêng dân tộc mình. 
                    </div>
                </div>
            </div>
            ...
            <div className="Section1__menu">
                <div className="container">
                    <div className="Section1__menu__inner">
                        <label className="Section1__menu__inner__tab lable1p2" for="inner1p3" style={{color: "#FFFFFF"}}>Cồng </label>
                        <label className="Section1__menu__inner__tab lable2p2" for="inner2p3" style={{color: "#FFFFFF"}}>Chiêng</label>
                        <label className="Section1__menu__inner__tab lable3p3" for="inner3p3" style={{color: "#FFFFFF"}}>Đàn đá</label>
                        <label className="Section1__menu__inner__tab lable4p3" for="inner4p3" style={{color: "#FFFFFF"}}>Đàn Tơ Rưng</label>
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    ...
                    <div className="Section1__content__inner inner1p3">
                        ...
                        <div className="Section1__content__inner__row">
                            ...
                            <div className="Section1__content__inner__row__text">
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    Cồng được chế tác từ hợp kim đồng, đôi khi còn pha lẫn vàng, bạc hoặc đồng đen mang trong mình âm thanh vang vọng của núi rừng Tây Nguyên. Cồng với núm đặc trưng và chiêng không núm, mỗi loại lại có những đặc điểm riêng biệt nhưng luôn xuất hiện cùng nhau trong các buổi hòa tấu tạo nên những giai điệu độc đáo.
                                </div>
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    Cồng là nhạc cụ dân tộc thuộc bộ gõ, được làm bằng đồng thau, hình tròn như chiếc nón quai thao, đường kính khoảng từ 20 cm đến 60 cm, ở giữa có hoặc không có núm. Nghệ nhân dùng dùi gỗ có quấn vải mềm (hoặc dùng tay) để đánh. Cồng càng to thì tiếng càng trầm, càng nhỏ thì tiếng càng cao.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/khonggianvanhoacongchieng/2.1.jpeg" />
                                </div>
                    ...
                    <div className="Section1__content__inner inner2p3">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    Chiêng Êđê một bộ có 10 chiếc. Ba chiếc có núm gọi là Ching, giữ trách nhiệm là bè đệm cho hòa tấu. Bảy chiếc không có núm gọi là knă, đảm nhận phần giai điệu chính (trừ chiêng Char). Thường người ta sử dụng có 9 chiếc, còn ching Moong chỉ dùng khi có đám tang. Tiết tấu chiêng Êđê rất nhanh, dồn dập, sôi nổi như thác reo như gió thổi. Đòi hỏi trình độ diễn tấu của nghệ nhân phải rất điêu luyện mới có thể cùng hòa tấu được.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
                                    <img src="/image/khonggianvanhoacongchieng/2.2.jpg" />
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color: "#FFFFFF"}}>
                                    Ảnh: <b>“Dàn chiêng Aráp của người Jarai được trưng bày tại Bảo tàng tỉnh Đắk Lắk.”</b>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color: "#FFFFFF"}}>
                                    Nguồn: <b>sohuutritue.net.vn.</b>
                                </div>
                            </div>
                        </div>
                        {/* <div className="Section1__content__inner__icon">
                    ...
                    <div className="Section1__content__inner inner3p3">
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    Đàn đá thường được hình thành từ nhiều thanh, làm bằng đá sừng, hoặc đá nham... Cách thức ghè đẽo khá tinh xảo và chau chuốt; kích thước dài, ngắn, dày, mỏng khác nhau để cho được các thang âm trầm bổng, thánh thót khi gõ. 
                                </div>
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    Thanh đá dài, to, dày thường có âm trầm và trong. Ngược lại thanh đá ngắn, nhỏ, mỏng thì tiếng thanh... Kích thước của đàn đá thường khá dài nên ít được treo mà được các nghệ nhân đặt nằm song song nhau trên một giá đỡ ngang trong quá trình diễn tấu. Bộ đàn đá thời tiền sử gồm 11 thanh được phát hiện đầu tiên vào năm 1949 tại tỉnh Đắk Lắk. 
                                </div>
                                <div className="Section1__content__inner__text" style={{color: "#FFFFFF"}}>
                                    Đàn đá Đăk Kar được làm từ chất liệu đá sừng Cordierit, qua gia công ghè đẽo, chế tác người tiền sử đã tạo ra bộ đàn đá hoàn chỉnh gồm 3 thanh: thanh Tru (cha), thanh T’rơ (mẹ) và thanh Tê (con). 
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
                                ...
                                <div className="Section1__content__inner__video" style={{marginTop:"0px"}}>
                                    <iframe width="100%" height="200px" src="https://www.youtube.com/embed/j2xCBwDYRlI?si=Ak347vknZtQoGScG" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color: "#FFFFFF"}}>
                                    Video: <b>“Cô gái vót chông - Đàn đá Tây Nguyên”</b>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="Section1__content__inner inner4p3">
                        <div className="Section1__content__inner__row">
                            ...
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__video" style={{marginTop:"0px"}}>
                                    <iframe width="100%" height="200px" src="https://www.youtube.com/embed/6buOmlCbQ_s?si=uXUWPb_7hnluNitL" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color: "#FFFFFF"}}>
                                    Video: <b>“Đàn T'rưng”</b>
                                </div>
                            </div>
                        </div>
                    </div>
