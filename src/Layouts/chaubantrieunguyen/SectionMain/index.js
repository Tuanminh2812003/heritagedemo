                ...
                <div className="container">
                    <div className="SectionMainP2__inner">
                        <div className="SectionMainP2__inner__title">
                            Dự án HeritageFlash XR Chào mừng quý khách đến trải nghiệm về Châu bản triều Nguyễn!
                        </div>
                        ...
                        <ul>
                            <li>
                                Giới thiệu khái quát về di sản Châu bản triều Nguyễn
                            </li>
                            <li>
                                Biết cách sưu tầm và sử dụng tư liệu lịch sử để tìm hiểu về Châu bản triều Nguyễn.
                            </li>
                            <li>
