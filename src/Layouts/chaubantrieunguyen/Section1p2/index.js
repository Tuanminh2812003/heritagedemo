            ...
            <div className="Section1__menu">
                <div className="container">
                    <div className="Section1__menu__inner">
                        <label className="Section1__menu__inner__tab lable1p2" for="inner1p2" style={{backgroundColor:"#E3DAD2"}}>Giá trị nổi bật của Châu bản</label>
                        <label className="Section1__menu__inner__tab lable2p2" for="inner2p2" style={{backgroundColor:"#E3DAD2"}}>Hình thức ngự phê trên Châu bản</label>
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    ...
                    <div className="Section1__content__inner inner2p2">
                        ...
                        <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Châu cải (硃 改) là chữ, câu, đoạn viết bên cạnh những chữ đã sổ bỏ nhằm sửa lại hoặc thể hiện quan điểm của nhà vua. 
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__image" >
