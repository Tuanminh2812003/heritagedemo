...
function Section5(){
    return(
        <>
            <div className="Section5" style={{backgroundColor: "#F3E7DB", paddingTop: "0px"}}>
                <div className="container">
                    <div className="Section5__inner">
                        ...
                        <div className="Section5__inner__row2">
                            ...
                            >
                                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/8jiCJlp5NpU?si=CI-hZYlViUCT-W6r" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                            </div>
                        </div>
                        <div className="Section5__inner__row1">
                            <div className="Section5__inner__row1__text">
                            ...
                            style={{backgroundImage: "url('/TNTM/Section1-4.jpg')",}}
                            >
                        ...
                        <div className="Section5__inner__row2">
                            ...
                            >
                                <div className="Section5__inner__row1__image__inner"
                            style={{backgroundImage: "url('/TNTM/Section5.1new.png')",}}
                            >
