            ...
            >
                <div className="container">
                    <div className="SectionMainP2__inner">
                        ...
                        Dự án Heritage Flash XR Chào mừng quý khách đến trải nghiệm về di sản tín ngưỡng thờ cúng Hùng Vương:
                        </div>
                        <div className="SectionMainP2__inner__disc">
                        Tham gia trải nghiệm về tín ngưỡng thờ cúng Hùng Vương quý khách sẽ: 
                        </div>
                        <ul>
                            <li>
