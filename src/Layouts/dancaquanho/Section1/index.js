                        ...
                        <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text" style={{color:"#FFFFFF"}}>
                                    Dân ca Quan họ là một loại hình dân ca truyền thống đặc sắc của vùng đồng bằng Bắc Bộ, là một hình thức hát giao duyên giữa các liền anh, liền chị. Những liền anh trong trang phục truyền thống khăn xếp, áo the và những liền chị duyên dáng trong bộ áo mớ ba, mớ bảy, đầu đội nón thúng quai thao, cùng nhau hát đối những câu ca mộc mạc, đằm thắm tạo nên một không gian âm nhạc độc đáo. 
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__video" style={{margin: "0px"}}>
                                    <iframe width="100%" height="200px" src="https://www.youtube.com/embed/0_gKFafPwHQ?si=iS4WCuwAC72yNINI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                                <div className="Section1__content__inner__video__disc" style={{color:"#FFFFFF"}}>
                                    Video: <b>“Tiết mục “Vui bốn mùa” do Đoàn nghệ thuật tỉnh Bắc Ninh biểu diễn”</b>
                                </div>
                            </div>
                        </div>
