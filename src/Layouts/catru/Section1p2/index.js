                    ...
                    <div className="Section1__content__inner__row">
                            <div className="Section1__content__inner__row__text">
                                ...
                                <div className="Section1__content__inner__text">
                                    Ca trù thường được biểu diễn trong các không gian nhỏ, sân khấu gói gọn trên 1 chiếc chiếu với đào hát ở giữa, kép và quan viên ngồi ở hai bên. Nếu bài hát được sáng tác và trình diễn ngay tại chỗ sẽ gọi là tức tịch (ngay ở chiếu). Một bài hát Ca trù sẽ gồm có 3 nghệ nhân chính. Ca trù sử dụng các nhạc cụ đặc trưng như trống, đàn đáy tạo nên âm thanh thanh thoát, sâu lắng, mang đậm âm hưởng dân gian. Ca trù mang tính dân tộc cao và thể hiện được bản sắc của dân tộc.
                                </div>
                            </div>
                            <div className="Section1__content__inner__row__image">
                                <div className="Section1__content__inner__video" style={{marginTop: "0px"}}>
                                    <iframe width="100%" height="200px" src="https://www.youtube.com/embed/-SBFc_rcbio?si=yb1fN-mjgTeqqF_O" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                                <div className="Section1__content__inner__video__disc">
                                  Video: <b>“Hành trình tìm về cội nguồn: Nghệ nhân ưu tú Vân Mai và thế giới ca trù | Người tốt quanh ta”</b>
                                </div>
                            </div>
                        </div>
                        {/* <div className="Section1__content__inner__text">
