                ...
                <div className="container">
                    <div className="Section7__inner">
                        ...
                        <div className="Section7__inner__disc">
                            Bạn hãy thiết kế một video/poster hoặc lá thư để thể hiện chủ đề: “Cảm nghĩ sau khi tìm hiểu thông tin về di sản trên website/Đề xuất những biện pháp bảo tồn và quảng bá hình ảnh di sản Đờn ca tài tử Nam Bộ”.
                        </div>
                        <div className="Section7__inner__disc">
